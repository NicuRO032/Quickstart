...
public class AutoVision11 extends CommandOpMode {
    ...
    private final Pose ControlPoint = new Pose(74, 55.5);
    private final Pose GRAB2_START_POSE  = new Pose(47, 66, Math.toRadians(180));
    private final Pose GRAB2_END_POSE  = new Pose(5, 62, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        grab1Path = follower.pathBuilder()
                ...
                //.addPoseCallback(GRAB1_END_POSE, () -> intake.setPower(-0.5), 7)
        ...
        grab2Path = follower.pathBuilder()
                ...
                .addParametricCallback(0.0, () -> follower.setMaxPower(1.0))
                .addParametricCallback(0.45, () -> follower.setMaxPower(0.37))
        ...
        if (!autoStarted) {
            ...
            SequentialCommandGroup autoSequence = new SequentialCommandGroup(
                    new ParallelCommandGroup(
                        ...
                        new InstantCommand(() -> carousel.setShooterForAutoRPM(3100)),
