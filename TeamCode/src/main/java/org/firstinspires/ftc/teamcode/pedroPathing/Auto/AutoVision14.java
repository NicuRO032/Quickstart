...
public class AutoVision14 extends CommandOpMode {
    ...
    private final Pose ControlPoint2_1 = new Pose(134, 21);
    private final Pose GRAB1_END_POSE = new Pose(133, 30, Math.toRadians(0));
    private final Pose GRAB2_START_POSE = new Pose(129, 13, Math.toRadians(-40));
    private final Pose GRAB2_END_POSE = new Pose(129,10,Math.toRadians(-40));
