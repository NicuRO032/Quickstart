...
public class ShootAllBallsSlowCommand extends SequentialCommandGroup {

    public static final long SHOOTER_TIMEOUT_MS = 3000;

            //Comanda folosita in AUTO din shooting zone mic pentru a arunca slow.

    public ShootAllBallsSlowCommand(CarouselSubsystem1 carousel) {
        addCommands(
                ...
                new InstantCommand(carousel::triggerSlowShoot)
