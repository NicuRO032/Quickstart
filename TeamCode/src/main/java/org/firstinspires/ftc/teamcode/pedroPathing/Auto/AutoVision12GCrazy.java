...
//    private final Pose GRAB2_END_POSE = new Pose(133, 67, Math.toRadians(53));// artefacte gate
    private final Pose GRAB2_END_POSE = new Pose(135, 72, Math.toRadians(53));// artefacte gate
    private final Pose GRAB3_END_POSE = new Pose(138, 90, Math.toRadians(0)); // set 1 artedfacte
    private final Pose ControlPoint1 = new Pose(81,59);
    private final Pose ControlPoint2 = new Pose(110, 61);
    private final Pose ControlPoint3 = new Pose(83, 88);
