...
public class AutoVision11GCrazy extends CommandOpMode {
    ...
    private final Pose GRAB2_END_POSE = new Pose(11.5, 64, Math.toRadians(127));
    private final Pose GRAB2A_END_POSE = new Pose(9, 60, Math.toRadians(120));// artefacte gate
...
//                .addParametricCallback(0.65, () -> follower.setMaxPower(1)) // la 65% din path revine la viteza maxima
        ...
        grab2APath = follower.pathBuilder()
                .addPath(new BezierLine(GRAB2_END_POSE, GRAB2A_END_POSE)) // gate
                .setLinearHeadingInterpolation(GRAB2_END_POSE.getHeading(), GRAB2A_END_POSE.getHeading())
                .addParametricCallback(0.0, () -> follower.setMaxPower(1.0))  // porneste cu putere maxima
                .build();
