...
@Autonomous(name = "AUTO.small.blue.fara-g1", group = "Pedro Pathing")
public class AutoVision131 extends CommandOpMode {
    ...
    private final Pose GRAB2_END_POSE = new Pose(9,11,Math.toRadians(190));
    ...
    public void buildPaths() {
        ...
        grab2Path = follower.pathBuilder()
                ...
                .addPath(new BezierLine(SCORE_POSE, GRAB2_END_POSE))
